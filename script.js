...
window.openBcelApp = function(event) {
    ...
    if (!isMobile) {
        event.preventDefault(); // ປ້ອງກັນບໍ່ໃຫ້ລິ້ງເຮັດວຽກຖ້າເປີດໃນຄອມ
        alert("ຄຳເຕືອນ: ການເປີດແອັບທະນາຄານໂດຍກົງໃຊ້ໄດ້ສະເພາະເທິງໂທລະສັບມືຖືເທົ່ານັ້ນ! (ໃນຄອມພິວເຕີໃຫ້ໃຊ້ໂທລະສັບສະແກນ QR Code ຈາກໜ້າຈໍໄດ້ເລີຍ)");
    }
    // ຖ້າເປັນມືຖື ລະບົບຈະປ່ອຍໃຫ້ມັນເປີດ bcelone://app ໄປຫາແອັບທະນາຄານອັດຕະໂນມັດ
};