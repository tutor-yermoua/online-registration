...
window.openBcelApp = function(event) {
    ...
    if (!isMobile) {
        ...
        alert("ຄຳເຕືອນ: ການເປີດແອັບທະນາຄານໂດຍກົງໃຊ້ໄດ້ສະເພາະເທິງໂທລະສັບມືຖືເທົ່ານັ້ນ! (ໃນຄອມພິວເຕີໃຫ້ໃຊ້ໂທລະສັບສະແກນ QR Code)");
    } else {
        // ຖ້າເປັນມືຖື: ໃຫ້ລະບົບພະຍາຍາມເປີດແອັບ
        // ຖ້າເຄື່ອງໃດບໍ່มีແອັບ ມັນຈະກັນບໍ່ໃຫ້ໜ້າເວັບຄ້າງ
        setTimeout(function() {
            // (ທາງເລືອກ) ຖ້າຕ້ອງການให้ມັນພາໄປ App Store / Play Store ຖ້າບໍ່ມີແອັບ 
            // ໃຫ້ໃສ່ລິ້ງດາວໂຫຼດໄວ້ບ່ອນນີ້, ຖ້າບໍ່ຢากໃສ່ໃຫ້ລຶບບັນທັດລຸ່ມນີ້ອອກໄດ້
        }, 1000);
    }
};